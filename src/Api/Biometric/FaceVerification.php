...
class FaceVerification extends ApiBase
{
    ...
    function __construct()
    {
        $this->initFields([
            ...
            RequestPayload::Field('face', 'string', true, null, 'Selfie photo in base64 or URL, you can provide multiple frames of images captured continuously by separating each image with a comma (,). You may also reference image from another transaction by passing "ref:abcde" where abcde is the output image reference.'),
            RequestPayload::Field('faceVideo', 'string', true, null, 'Selfie video in base64 or remote URL.'),
