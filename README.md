...
This is a PHP SDK for [ID Analyzer Identity Verification APIs](https://www.idanalyzer.com), though all the APIs can be called with without the SDK using simple HTTP requests as outlined in the [documentation](https://developer.idanalyzer.com/help), you can use this SDK to accelerate server-side development.
...
## Quick Start
[Quick start with client library](https://developer.idanalyzer.com/help/quick-start)
...
## SDK Reference
Check out [ID Analyzer PHP Reference](https://developer.idanalyzer.com/help/php)
